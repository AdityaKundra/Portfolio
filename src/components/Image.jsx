import image from '../assets/photos/IMG_2605.jpeg'

const Image = () => {
    return (
        <>
            {/* <div className='absolute top-0 left-0 modal min-h-screen min-w-screen z-10 flex justify-center items-center shadow-2xl ' style={{ boxShadow: 'rgba(0, 0, 0, 0.15) 0px 10px 30px 0px' }}>bg-[#00000012] */}
                <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] bg-white rounded-xl z-20 p-2 shadow-2xl' style={{ boxShadow: 'rgba(0, 0, 0, 0.15) 0px 10px 30px 0px' }}>
                    <div className='header flex items-center justify-between mb-2'>
                        ...
                        <p className='text-sm text-[#272727] font-medium'>
                            IMG_2300
                        </p>
