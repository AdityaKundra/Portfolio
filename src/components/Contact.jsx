...
const Contact = () => {
    return (
        <div className="absolute top-0 left-0 modal min-h-screen min-w-screen z-10 flex justify-center items-center shadow-2xl animate-[fadeInScale_0.3s_ease-out]" style={{ boxShadow: 'rgba(0, 0, 0, 0.15) 0px 10px 30px 0px' }}>
            <div className='w-[460px] bg-[white] rounded-xl z-20'>
                ...
                <div className="p-8 flex flex-col items-center">
                    ...
                    {/* Action Button */}
                    <button className="mt-6 px-5 py-2 bg-black text-white text-sm rounded-lg cursor-pointer transition">
                        Get in Touch
                    </button>
                </div>
            </div>
