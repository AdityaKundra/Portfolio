...
const Headbar = () => {
    ...
    return (
        <div className='w-full px-5 py-2 flex items-center justify-between bg-[#fafafa] dark:bg-[#2d2d2d] transition-colors'>
            <div className='leftHeader gap-4 flex items-center'>
                ...
                <a href={`mailto:${contact.email}`} className='contactInfo text-sm cursor-pointer font-[500] text-[#1d1d1f] dark:text-[#f5f5f7] hover:opacity-80'>
                    Contact
                </a>
                {/* <span className='contactInfo text-sm cursor-pointer font-[500]'>
                    Contact
                </span> */}
                <a href='https://drive.google.com/file/d/1Y5SerpDnMvF0BpDn11yJozSNHiyTx1m-/view?usp=sharing' className='resumeLink text-sm cursor-pointer font-[500] text-[#1d1d1f] dark:text-[#f5f5f7] hover:opacity-80' target='_blank'>
                    Resume
                </a>
            ...
            <div className='rightHeader gap-2 flex items-center justify-center'>
                ...
                <span className='clock text-sm cursor-pointer font-[500] text-[#1d1d1f] dark:text-[#f5f5f7]'>
