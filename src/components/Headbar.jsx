    ...
    return (
        <div className='w-full px-5 py-2 flex items-center justify-between' style={{ backgroundColor: '#fafafa' }}>
            <div className='leftHeader gap-4 flex items-center'>
                ...
                <a href={`mailto:${contact.email}`} className='contactInfo text-sm cursor-pointer font-[500]'>
                    Contact
                </a>
                {/* <span className='contactInfo text-sm cursor-pointer font-[500]'>
                    Contact
                </span> */}
                <a href='src/assets/Aditya_Kundra_Resume_FullStack.pdf' className='resumeLink text-sm cursor-pointer font-[500]' target='_blank'>
                    Resume
                </a>
            ...
            <div className='rightHeader gap-2 flex items-center justify-center'>
                ...
                <span className='clock text-sm cursor-pointer font-[500]'>
